...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=28 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock data result
...
module  sqrt_alt_sqrt_block_9kb
	( 
	aclr,
	clken,
	clock,
...
endmodule //sqrt_alt_sqrt_block_9kb

//synthesis_resources = lpm_add_sub 27 reg 1433 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  sqrt_altfp_sqrt_ued
	( 
	clk_en,
	clock,
	data,
...
`endif
	...
	sqrt_alt_sqrt_block_9kb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
module sqrt (
	...
	sqrt_altfp_sqrt_ued	sqrt_altfp_sqrt_ued_component (
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
				.result (sub_wire0));
